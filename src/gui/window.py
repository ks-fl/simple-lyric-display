...
from PySide6.QtWidgets import (QMainWindow, QWidget, QMenu, QSizeGrip, 
                             QSystemTrayIcon, QApplication)
from PySide6.QtGui import (QColor, QFont, QPainter, QPen, QBrush, 
                          QPainterPath, QFontMetrics, QPalette)
...
class LyricsWidget(QWidget):
    ...
    def paintEvent(self, event):
        ...
        # Draw Metadata
        self.draw_text_with_outline(painter, self.meta.get('title', ''), scroll_offset, QColor("#00ffff"), True)
        self.draw_text_with_outline(painter, self.meta.get('artist', ''), scroll_offset + 50, QColor("#f0ad4e"), False)
    ...
    def draw_text_with_outline(self, painter, text, y, color, bold):
        ...
        painter.setPen(QPen(QColor(0, 0, 0, 230), 3, Qt.PenStyle.SolidLine, Qt.PenCapStyle.RoundCap, Qt.PenJoinStyle.RoundJoin))
...
class MainWindow(QMainWindow):
    ...
    def apply_theme_style(self):
        ...
        if mode == "GTK": QApplication.setStyle("gtk2")
        elif mode == "Qt": QApplication.setStyle("Fusion")
        else: QApplication.setStyle("Fusion")
        self.update()
